...
insert into utente(id, cognome, data_nascita, email, nome)  values (nextval('utente_seq'), 'Macale','2006-06-26' , 'andriu.macale@hotmail.com', 'Andrea');
...
insert into credenziali(id, password, role, username, utente_id) values (nextval('credenziali_seq'), '$2a$10$S6HueP.58CzXZhQtat/sGOHgpoRSDpYQ835AA3Gq1Pu2dOijVLzCS', 'PRESIDENTE', 'Andrea', (select id from utente where email = 'andriu.macale@hotmail.com')); 
